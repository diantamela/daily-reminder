        ...
        <div class="admin-card">
            <div class="admin-card-header">
                <h3 class="mb-0">
                    ...
                    <small class="opacity-75">#{{ $reminder->id }}</small>
                </h3>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <select class="admin-form-control @error('category') is-invalid @enderror" id="category" name="category" required>
                                    ...
                                    <option value="motivation" {{ old('category', $reminder->category) == 'motivation' ? 'selected' : '' }}>
                                        <i class="fas fa-rocket me-1"></i>Motivation
                                    </option>
                                    <option value="reflection" {{ old('category', $reminder->category) == 'reflection' ? 'selected' : '' }}>
                                        <i class="fas fa-brain me-1"></i>Reflection
                                    </option>
                                    <option value="self-discipline" {{ old('category', $reminder->category) == 'self-discipline' ? 'selected' : '' }}>
